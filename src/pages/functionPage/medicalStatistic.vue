...
<script>
import doctorRecord from "./medicalPart/doctorRecord";
import medicalWater from "./medicalPart/medicalWater";
...
export default {
  ...
  computed: {
    displayDoctorList() {
      return this.navtiveIndex == 0 ? "doctorRecord" : "medicalWater";
    }
  }
};
</script>
